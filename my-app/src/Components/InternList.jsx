      ...
      <div className="total-container">
        <div className="headeor-list">
          ...
          <div className="headeor-icons">
            <div className="icon-button-container">
              <i
                style={{ color: "#9D99C4" }}
                class="users-icon fa-solid fa-user-group"
              ></i>
              <button>
                Human Resource
                <br /> {counts.HRCount}{" "}
          ...
          <div className="inner-container">
            <div className="tabs">
              <div
                ...
                className={`tab ${
                  selectedTab === "OnGoing" ? "tab-active" : ""
                }`}
              >
                Ongoing
              </div>
              <div
                ...
                className={`tab ${
                  selectedTab === "Finished" ? "tab-active" : ""
                }`}
              >
                Finished
              </div>
              <div
                ...
                className={`tab ${
                  selectedTab === "Terminated" ? "tab-active" : ""
                }`}
              >
                Terminated
              </div>
        ...
        <div className="filters">
          <div className="inner-container">
            <button
              onClick={() =>
                setSelectedButtons((prevData) => ({
                  ...prevData,
                  humanResources: !prevData.humanResources,
                }))
              }
              className={`check-button ${
                selectedButtons.humanResources ? "selected" : ""
              }`}
            >
                ...
                <span className="check">
                  <i
                    className={`fa-solid fa-check ${
                      !selectedButtons.humanResources ? "hidden" : ""
                    } `}
                  ></i>
                </span>
              </div>
            ...
            <button
              ...
              className={`check-button ${
                selectedButtons.marketing ? "selected" : ""
              }`}
            >
              <div className="check-container">
                <span className="check">
                  <i
                    className={`fa-solid fa-check ${
                      !selectedButtons.marketing ? "hidden" : ""
                    } `}
                  ></i>
                </span>
              </div>
            ...
            <button
              ...
              className={`check-button ${
                selectedButtons.businessAnalysis ? "selected" : ""
              }`}
            >
              <div className="check-container">
                <span className="check">
                  <i
                    className={`fa-solid fa-check ${
                      !selectedButtons.businessAnalysis ? "hidden" : ""
                    } `}
                  ></i>
                </span>
              </div>
            ...
            <button
              ...
              className={`check-button ${
                selectedButtons.projectManagement ? "selected" : ""
              }`}
            >
              <div className="check-container">
                <span className="check">
                  <i
                    className={`fa-solid fa-check ${
                      !selectedButtons.projectManagement ? "hidden" : ""
                    } `}
                  ></i>
                </span>
              </div>
            ...
            <button
              ...
              className={`check-button ${
                selectedButtons.languageTeaching ? "selected" : ""
              }`}
            >
              <div className="check-container">
                <span className="check">
                  <i
                    className={`fa-solid fa-check ${
                      !selectedButtons.languageTeaching ? "hidden" : ""
                    } `}
                  ></i>
                </span>
              </div>
